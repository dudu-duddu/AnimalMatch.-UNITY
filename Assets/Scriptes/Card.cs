...
public class Card : MonoBehaviour
{
    ...
    public void FlipCard() {
        ...
        Vector3 originalSccale = transform.localScale;
        Vector3 targetScale = new Vector3(0f, originalSccale.y, originalSccale.z);
        ...
        transform.DOScale(targetScale, 0.2f).OnComplete(() =>
        {
            ...
            transform.DOScale(originalSccale, 0.2f).OnComplete(() => {
                isFlipping = false;
            });
        });
    }
